              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="register.php" method="post">
                    ...
                    <label>Alamat</label>
                    <div class="mb-3">
                      <textarea type="email" name="alamat" class="form-control" placeholder="Alamat Lengkap"><?php echo @$_SESSION['flash']['credidential']['alamat'] ?></textarea>
                    </div>
                    <label>Berat Badan (kg)</label>
                    <div class="mb-3">
                      <input  type="number" required value="<?php echo @$_SESSION['flash']['credidential']['info']['bb'] ?>" name="info[bb]" class="form-control" placeholder="Berat Badan">
                    </div>
                    <label>Tinggi Badan (cm)</label>
                    <div class="mb-3">
                      <input  type="number" required value="<?php echo @$_SESSION['flash']['credidential']['info']['tb'] ?>" name="info[tb]" class="form-control" placeholder="Tinggi Badan">
                    </div>
                    ...
                    <div class="mb-3">
                      <input  type="password" required onkeyup="checkPasswordMatch()" id="Cpassword" class="form-control" placeholder="Konfirmasi Password" aria-label="Password" aria-describedby="password-addon">
