...
$act    = $_GET['act'];
if($act == 'create'){
    $sql="INSERT INTO ".$table." (username,password,nama,no_telp,email,alamat,level,aktif,created_by,created_at,updated_by,updated_at,is_first)
    VALUES ('".$_POST['username']."', '".md5($_POST['password'])."','".$_POST['nama']."','".$_POST['no_telp']."','".$_POST['email']."','".$_POST['alamat']."','".$_POST['level']."','Y','$user','$now','$user','$now','0')";
    ...
    header('Location: ../../media.php?module='.$module.'&act=edit&id='.$_POST['id']);
}else if($act == 'delete'){
