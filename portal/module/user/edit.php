        ...
        <div class="col-md-12">
          <form method="POST" action="<?php echo $aksi ?>?module=<?php echo $_GET['module'] ?>&act=<?php echo $_GET['act'] ?>">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-xs-12 form-group">
                <label><?php echo ucwords(str_replace("_"," ", "Berat Badan (kg)")) ?></label>
                <input required type="text" class="form-control" name="bb" value="<?php echo json_decode($edit['info'],true)['bb'] ?>">
              </div>
              <div class="col-md-12 col-xs-12 form-group">
                <label><?php echo ucwords(str_replace("_"," ", "Tinggi Badan (cm)")) ?></label>
                <input required type="text" class="form-control" name="tb" value="<?php echo json_decode($edit['info'],true)['tb'] ?>">
              </div>
              <div class="col-md-12 col-xs-12 form-group">
                <label><?php echo ucwords(str_replace("_"," ", "level")) ?></label>
                <select class="form-control" name="level">
                  <?php foreach (array('administrator','user') as $key => $value): ?>
